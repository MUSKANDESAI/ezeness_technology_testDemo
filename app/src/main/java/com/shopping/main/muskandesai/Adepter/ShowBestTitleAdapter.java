...
public class ShowBestTitleAdapter extends RecyclerView.Adapter<ShowBestTitleAdapter.ViewHolder> {
    ...
    public ShowBestTitleAdapter(Context mContext, ArrayList<String> show_mname, ArrayList<Integer> show_user_logo) {
